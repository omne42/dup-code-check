...
- Scan pipeline: retry interrupted stdout reads/waits in Git streaming enumeration and always reap the `git` child process; other I/O errors still fall back to the walker (fail closed).
